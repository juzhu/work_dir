...
// 11-16
// 前进店
var content = "田鸡半价，你没看错，泡椒田鸡，香辣田鸡半价优惠，还有更多折扣美味，尽在周三美团外卖，11点之前订餐再减两元，赶紧下单吧。退订回T";

// 11-16 坪洲店
var last_days = 20; // 两天前的用户
var content = "下雨天凉，提前把午餐定好吧，记得中午要吃点好的！香辣田鸡加量不加价，让您一次吃过瘾，新上肥肠土鸡煲，拉上伙伴赶紧尝尝吧 !退订回T";  // 发送的内容

var content = "厉害了wordaa哥！水煮田鸡三斤装，酸汤肥牛超大份，美团周三半价/饿了么超级补贴。提前下单，在这不是很冷的冬至，让您一次吃个够！退订回T";  // 坪洲/前进
var content = "又到周五啦，一定要好好对待辛苦工作一周的自己哦，来份土鸡肥肠煲? 大份田鸡?朋友同事聚在一起，聊聊八卦吐吐槽，一起迎接周末吧。退订回T";  // 坪洲/前进
var content = "周三美团半价日，疯抢就一天，聚箸精选亲们最喜欢的菜品限量五折优惠，11点之前订餐美团再减两元，还不用饿着等外卖，赶紧下单吧。退订回T";
var content = "好久不见，甚是想念！聚箸上新海鲜香锅，土鸡肥肠煲,携手饿了么超级满减，邀您品尝.或许不是最美味，但保证能让您吃的最安心！退订回T";
...
//
// 前进店 半价
var sql = "select *, u.phone as send_phone from juzhu.juzhu_user_info as u left join user_market.user_last_sms_time as l on u.phone=l.phone where (u.last_order_time>'2016-09-01' and last_order_time<'2016-11-16') and (l.last_sms_time is null or l.last_sms_time<'2016-11-15') and (u.store_id&1)  or u.phone='17727828865'";

// 坪洲店 半价
var sql = "select *, u.phone as send_phone from juzhu.juzhu_user_info as u left join user_market.user_last_sms_time as l on u.phone=l.phone where (u.last_order_time>'2016-09-01' and last_order_time<'2016-11-16') and (l.last_sms_time is null or l.last_sms_time<'2016-11-15') and (u.store_id&2)  or u.phone='17727828865'";

var sql = "select *, u.phone as send_phone from juzhu.juzhu_user_info as u left join user_market.user_last_sms_time as l on u.phone=l.phone where (u.last_order_time>'2016-11-02' and last_order_time<from_unixtime(unix_timestamp(left(now(), 10)))) and (l.last_sms_time is null or l.last_sms_time<'2016-11-19') or u.phone='17727828865'";
// 2016-11-24
var sql = "select *, u.phone as send_phone from user_market.dinner_user_18 as u left join user_market.user_last_sms_time as l on u.phone=l.phone where (u.last_order_time>'2016-09-01' and last_order_time<'2016-11-20') and (l.last_sms_time is null or l.last_sms_time<'2016-11-21') or u.phone='17727828865'";

// 2016-11-29
var sql = "select *, u.phone as send_phone from juzhu.juzhu_user_info as u left join user_market.user_last_sms_time as l on u.phone=l.phone where ((u.last_order_time>'2016-10-01' and u.last_order_time<'2016-11-20') or (u.first_order_time > '2016-11-15' and u.first_order_time<'2016-11-28')) and (l.last_sms_time is null or l.last_sms_time<'2016-11-28') or u.phone='17727828865'";

// 2016-12-21 周三促销
var sql = "select *, u.phone as send_phone from juzhu.juzhu_user_info as u left join user_market.user_last_sms_time as l on u.phone=l.phone where ((u.last_order_time>'2016-11-20' and u.last_order_time<'2016-12-18') or (u.first_order_time > '2016-11-20' and u.first_order_time<'2016-12-21')) and (l.last_sms_time is null or l.last_sms_time<'2016-12-01') or u.phone='17727828865'";
// 2016-12-23  周五
var sql = "select *, u.phone as send_phone from juzhu.juzhu_user_info as u left join user_market.user_last_sms_time as l on u.phone=l.phone where ((u.last_order_time>'2016-12-01' and u.last_order_time<'2016-12-23') or (u.first_order_time > '2016-12-20')) and (l.last_sms_time is null or l.last_sms_time<'2016-12-22') or u.phone='17727828865'";

var sql = "select *, u.phone as send_phone from juzhu.juzhu_user_info as u left join user_market.user_last_sms_time as l on u.phone=l.phone where ((u.last_order_time<'2016-12-01' and u.last_order_time>'2016-10-01') and  (u.order_num>2) and (l.last_sms_time is null or l.last_sms_time<'2016-12-25')) or u.phone='17727828865'";
console.log(sql)
var phone = "";
